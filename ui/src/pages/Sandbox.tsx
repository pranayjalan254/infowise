...
import SyntheticDataGenerator from "@/components/ingestion/SyntheticDataGenerator";

const mockDocuments = [
  {
    id: "1",
    name: "Customer_Database_Q1.csv",
    status: "Masked",
    records: "1,247",
  ...
  {
    id: "2",
    name: "Employee_Records_2024.xlsx",
    status: "Masked",
    records: "892",
  ...
  {
    id: "3",
    name: "Financial_Report_March.pdf",
    status: "Masked",
    records: "2,156",
...
export default function Sandbox() {
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      type: "assistant",
      message:
        "Hello! I can help you query your selected dataset. What would you like to know?",
    },
  ]);
  ...
  const handleSendMessage = () => {
    ...
    setChatMessages((prev) => [
      ...
      {
        type: "assistant",
        message: "Based on your cleaned dataset, here are the insights...",
      },
    ]);
    setChatInput("");
  };
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <p className="text-muted-foreground">
          Explore insights, generate synthetic data, and query your cleaned
          datasets
        </p>
      </motion.div>
